...
# Function to create or get the SQLite connection in a thread-safe way
def get_sqlite_connection():
    conn = sqlite3.connect("todoapp.sqlite", isolation_level=None)
    return conn
...
# Create the table and update the schema
cur.execute(
    """
